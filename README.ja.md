...
1. [Releases](https://github.com/VideoSupporter/srt-probe-dev/releases) ページから最新版をダウンロード:
...
### バグ報告・機能リクエスト
問題を発見した場合や、新しい機能の提案がある場合は、[GitHub Issues](https://github.com/VideoSupporter/srt-probe-dev/issues) でお知らせください。
